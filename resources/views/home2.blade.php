                            ...
                            <div class="row justify-content-center passwords mt-4">
                                ...
                                @foreach($passwords as $password)
                                    ...
                                    <p class="w-100">
                                        ...
                                        <input readonly type="password" id="userPassword" name="{{ $password->id }}" class="form-control mr-2" value="{{ $password->password }}" aria-label="Contraseña del usuario" aria-describedby="button-addon2" />
                                        <div>
