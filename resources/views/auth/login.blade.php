    ...
    <div class="row justify-content-center">
        <div class="card">
            <div class="image-container">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="300" height="300"
                    ...
                    <path
                        ...
                        transform="translate(-165.00003 -189.93073)" fill="#2f2e41" />
                    <path d="M1004.98163,709.57417h-738.294a1.19069,1.19069,0,0,1,0-2.38137h738.294a1.19069,1.19069,0,0,1,0,2.38137Z"
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="test@test.com">
