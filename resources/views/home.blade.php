                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            ...
                            <form action="/home/delete/{{ $password->id }}" method="POST">
                                @csrf
                                @method('DELETE')

                                <button type="submit" onclick="return confirm('¿Está seguro que desea eliminar esta contraseña?')" title="Borrar contraseña" id="borrarBoton" class="btn btn-outline-danger">
