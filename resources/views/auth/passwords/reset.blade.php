    ...
    <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="image-container">
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="570" height="511.67482" viewBox="0 0 570 511.67482"
            ...
            <div class="form-container">
                <p class="form-container-header">{{ __('Iniciar sesión') }}</p>
