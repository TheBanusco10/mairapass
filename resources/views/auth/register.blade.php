    ...
    <div class="row justify-content-center">
        <div class="card">
            <div class="image-container">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 676 676"
                    ...
                    <path
                        ...
                        transform="translate(-262 -112)" opacity="0.2" />
                    <path d="M701.96,648.27l1.22.63C703.06006,650.2,702.77,651,701.96,648.27Z" transform="translate(-262 -112)"
                        fill="#2f2e41" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-262 -112)" fill="#2f2e41" />
                    <path d="M675.00335,303.87618s-7.59666,34.93809,39.87428,48.91333Z" transform="translate(-262 -112)"
                        fill="#2f2e41" />
                    <path d="M468.86862,310.23519s17.469,39.06051-34.93809,56.52955Z" transform="translate(-262 -112)" fill="#2f2e41" />
                    <ellipse cx="489.41344" cy="514.60154" rx="8.28703" ry="19.88888"
                        transform="translate(-382.60837 38.98959) rotate(-15.63946)" fill="#d0cde1" />
                    <ellipse cx="688.30226" cy="498.02747" rx="19.88888" ry="8.28703"
                        transform="translate(-113.09381 1042.41397) rotate(-86.47577)" fill="#d0cde1" />
                </svg>
            </div>
            <div class="form-container" style="width: 350px;">
                <p class="form-container-header">{{ __('Registrarse') }}</p>
