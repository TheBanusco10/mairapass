    ...
    <div class="row justify-content-center">
        <div class="card">
            <div class="image-container">
                <svg class="p-4" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="250" height="250"
                    viewBox="0 0 543.21934 633.6012" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <path
                        ...
                        transform="translate(-328.39033 -133.1994)" fill="#f2f2f2" />
                    <path
                        ...
                        transform="translate(-328.39033 -133.1994)" fill="#fff" />
                    <path d="M655.673,201.175H451.26661a4.408,4.408,0,1,1,0-8.81606H655.673a4.408,4.408,0,0,1,0,8.81606Z"
                        transform="translate(-328.39033 -133.1994)" fill="#e6e6e6" />
                    <path d="M759.14708,248.20578H451.26661a4.408,4.408,0,1,1,0-8.81606H759.14708a4.408,4.408,0,0,1,0,8.81606Z"
                        transform="translate(-328.39033 -133.1994)" fill="#e6e6e6" />
                    <path d="M759.14708,295.23659H451.26661a4.408,4.408,0,1,1,0-8.81606H759.14708a4.408,4.408,0,0,1,0,8.81606Z"
                        transform="translate(-328.39033 -133.1994)" fill="#e6e6e6" />
                    <path d="M759.14708,295.23659H451.26661a4.408,4.408,0,1,1,0-8.81606H759.14708a4.408,4.408,0,0,1,0,8.81606Z"
                        transform="translate(-328.39033 -133.1994)" fill="#e6e6e6" />
                    <path
                        ...
                        transform="translate(-328.39033 -133.1994)" fill="#ffb6b6" />
                    <path
                        ...
                        transform="translate(-328.39033 -133.1994)" fill="#3f3d56" />
                    ...
                    <path
                        ...
                        transform="translate(-328.39033 -133.1994)" fill="#2f2e41" />
                    ...
                    <path
                        ...
                        transform="translate(-328.39033 -133.1994)" fill="#6c63ff" />
                    <path
            ...
            <div class="form-container">
                <p class="form-container-header">{{ __('Confirme su contraseña') }}</p>
